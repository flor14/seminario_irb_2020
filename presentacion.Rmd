...
.footnote[[Marwick(2018)](https://doi.org/10.1080/00031305.2017.1375986)]
---
...
✔️Agregar una estructura de archivos `analysis/` y `data/`

✔️Generar el manuscrito con código incluido en `RMarkdown` 

✔️️Usar la plantilla del journal con el paquete `rticles`

✔️️Manejar las dependencias 


```{r rc2, echo = FALSE, out.width=600}
...
Vasiliki Bitsouni, Samantha Lycett, Tanja Opriessnig, & Andrea Doeschl-Wilson. (2020, March 2). Vaccine Effectiveness In The Field -- An Interactive R Shiny Modelling App (Version v1.0.0). PLOS ONE. Zenodo. http://doi.org/10.5281/zenodo.3693547
---
...
[ELife Sciences](https://elifesciences.org/articles/30274/executable)
...
.pull-right[
```{r ropen, echo = FALSE, out.width=200}
...
.pull-right[
```{r open, echo = FALSE, out.width=200, fig.align='right'}
...
.pull-right[
```{r rh, echo = FALSE, out.width=200, fig.align='right'}
